...
class ProviderSampleSix extends StatelessWidget {
  const ProviderSampleSix({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: ProviderSampleSixHome(),
    );
  }
}

class ProviderSampleSixHome extends StatelessWidget {
  const ProviderSampleSixHome({Key? key}) : super(key: key);
...
class FirstConsumer extends StatelessWidget {
  const FirstConsumer({
    Key? key,
  }) : super(key: key);
        ...
        return Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                'You pressed ${firstValue.count} times',
...
class SecondConsumer extends StatelessWidget {
        ...
        return Column(
          children: [
            ...
            Container(
              ...
              padding: const EdgeInsets.all(5),
              child: Text(
                'You pressed ${secondValue.num} times',
                style: const TextStyle(
                  fontSize: 60,
                  fontFamily: 'Allison',
                  fontWeight: FontWeight.bold,
